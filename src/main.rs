...
//                        && p.presentation_support(i as u32, event_loop).unwrap()
    ...
    let ext_support = physical_device.supported_extensions();
    let feat_support = physical_device.supported_features();
    let use_fp16 = ext_support.khr_16bit_storage
        && feat_support.storage_buffer16_bit_access
        && feat_support.shader_float16;
