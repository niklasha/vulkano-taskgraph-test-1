...
//                        && p.presentation_support(i as u32, event_loop).unwrap()
    ...
    // Check for cooperative matrix (WMMA) support. This includes both the
    // vendor-specific NV extension and the cross-vendor KHR extension which is
    // used by AMD GPUs as well.
